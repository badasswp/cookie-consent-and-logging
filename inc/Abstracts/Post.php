...
abstract class Post {
	...
	protected static function get_query( $args = [] ) {
		 ...
		 */
		$cache_name = apply_filters( 'cookie_consent_and_logging_post_query_cache_name', $cache_name, $query_args );
		 ...
		 */
		$query_args = apply_filters( 'cookie_consent_and_logging_post_query_args', $query_args );
