...
/**
 * Consent IP Address class.
 */
class ConsentIPAddress extends MetaBox {
	/**
	 * Meta box name.
	 *
	 * @since 1.0.0
	 ...
	 * @var string
	 */
	public static $name = 'ccal_consent_ip_address';
