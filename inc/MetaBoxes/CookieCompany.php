...
/**
 * Cookie Company class.
 */
class CookieCompany extends MetaBox {
	/**
	 * Meta box name.
	 *
	 * @since 1.0.0
	 ...
	 * @var string
	 */
	public static $name = 'ccal_cookie_company';
	...
	public function get_metabox_callback( $post ): void {
		...
		$cookie_company = get_post_meta( $post->ID, static::$name, true );
